...
#define WIFI_SSID "sriixda"
#define WIFI_PASS "123456789"
#define API_KEY "JosBIMyYWOj9oQCjphDlnxaQhKCz52w0UEF5pkAWYePEFehFzrjWKPIkeORd0x95eMji0yEaMnZAwdv32Gz45BS67aB9NAe6yhXVzrzj1Y8yUZjylZmpHx1ECdIZD2dA"
...
void send_sensor_data(float temperature, float humidity, bool switchStatus) {
    if (WiFi.status() == WL_CONNECTED) {
        ...
        String url = "http://192.168.1.289:3300/sensor-data";  // Ensure this IP is correct
